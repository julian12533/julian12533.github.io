...
<body>
    ...
    <form action="res/resultado_mayor_dos.php" method="get" >
        <label>Numero 1:</label><br>
        <input type="text"  placeholder="Ingresa el primer numero " name="Nm1"><br>
        <label>Numero 2:</label> <br>
        <input type="text"  placeholder="Ingresa el segundo numero " name="Nm2">        
        <br>
        <br>
        <input type="submit" >
    </form>
